// frontend/src/UserLocalFluTrends.jsx
  ...
  return (
    <Box sx={{ mt: 4 }}>
      <Typography variant="h4" gutterBottom textAlign="center" sx={{ mb: 3 }}>
       Bimontly Home State ({userData.state}) CDC Influenza-like Illness Surveillance (ILINet) for {user.username} 
      </Typography>
...
export default UserLocalFluTrends;
// frontend/src/CreateReportForm.jsx
    ...
    >
      <Box
        ...
        sx={{
          ...
          gap: 2,
          width: "100%",
          maxWidth: "600px", // ✅ keeps form ~50% width on large screens
        }}
      >
        ...
        <FormControl
          fullWidth
          error={formik.touched.primary_symptom && Boolean(formik.errors.primary_symptom)}
        >

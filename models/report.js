...
class Report {
    ...
    static async createNewReport(
        ...
        const result=await db.query(`INSERT INTO
            ...
            zipcode,
            latitude,
            longitude) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
            RETURNING * `, [user_id, primary_symptom, symptoms, severity, temperature, notes, zipcode, latitude, longitude])
